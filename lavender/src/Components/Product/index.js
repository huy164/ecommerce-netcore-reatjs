          ...
          <div className="detail-product__box-name">
            <div className="cps-container">
              <div className="box-name__box-product-name">
                <h1>{this.props.match.params.dong !== "sub" && this.props.match.params.dong + " "}{this.props.match.params.sanpham} </h1>
              </div>
            </div>
          </div>
              ...
              <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                ...
                <div className="box-action-button">
                  <button
                    ...
                    >
                  {this.state.dongia === 0 ? <h4>HẾT HÀNG</h4> : <h4>THÊM GIỎ HÀNG</h4>}
                </button>
                <div
                  class="fb-like"
        ...
        <div className="row">
          <div className="col-md-12">
            ...
            <div className="card card-nav-tabs">
              ...
              <div className="card-body product-extra_info">
