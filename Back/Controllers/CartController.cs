...
namespace Back.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        [Route("/muahang")]
        [HttpPost]
        public async Task<IActionResult> MuaHang(int makhachhang, int makhuyenmai, int phivanchuyen, float tongtien, [FromBody] JsonElement json)
        {
            ...
            foreach (var i in cartpayinglist)
            {
                ...
                // reset tinh trang to san co
                List<Chitietsanpham> ctsp_list = (from ctsp in lavenderContext.Chitietsanpham
                                                select ctsp).ToList();

                foreach (Chitietsanpham ctsp in ctsp_list)
                {
