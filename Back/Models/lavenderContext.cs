...
namespace Back.Models
{
    public partial class lavenderContext : DbContext
    {
        ...
        private const string connectionString = @"Server=localhost; Port=3306; Database=lavender; user=root; password=";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Baiviet>(entity =>
            {
                ...
                entity.Property(e => e.mabaiviet).HasColumnName("MABAIVIET");//a
            ...
            {
                entity.HasKey(e => e.maphivanchuyen)
                      .IsClustered(false);

                entity.ToTable("phivanchuyen");

                entity.Property(e => e.maphivanchuyen).HasColumnName("MAPHIVANCHUYEN");

                entity.Property(e => e.khoangcachmin).HasColumnName("KHOANGCACHMIN");

                entity.Property(e => e.khoangcachmax).HasColumnName("KHOANGCACHMAX");
            ...
            modelBuilder.Entity<Chitiethoadon>(entity =>
            {
                ...
                entity.Property(e => e.Dadanhgia).HasColumnName("DADANHGIA");
